...
# ============================================================
# CROWN Verification Runner (Naive Half-Opt) for MP-SPDZ
#
# Runs crown_naiveopt.mpc -- hybrid version where only the core
# CROWN backward pass (Part 2) stays naive (@for_range),
# all other parts use @for_range_opt.
#
#   Part 1 (opt):   Initial layer bounds
#   Part 2 (naive): Core CROWN backward (states, alpha, corrections)
#   Part 3 (opt):   Last-layer W_diff/b_diff extraction
#   Part 4 (opt):   Final backward pass + assembly
#
# Results saved to: crown-results/<protocol>/crown_naiveopt/<model>/eps_<eps>/
#
# Usage:
#   ./run_crown_naiveopt.sh [protocol] [model_config]
#
# Examples:
#   ./run_crown_naiveopt.sh semi
#   ./run_crown_naiveopt.sh semi cifar_5layer_100
#   ./run_crown_naiveopt.sh semi-online cifar_5layer_100
#
...
#   FAKE_PREP_SIZE     - fake preprocessing count for online-only mode (default: 100000000)
# ============================================================
...
MPC_VARIANT="crown_naiveopt"
MPC_SOURCE="crown/crown_naiveopt"
...
echo "========================================"
echo "CROWN Verification on MP-SPDZ (Naive Half-Opt)"
echo "========================================"
...
# Program name: crown/crown_naiveopt-<num_layers>-<d0>-...-<dN>
...
# 【缺少的修正】：
PROGRAM_NAME=$(basename "$PROGRAM_NAME") # 必须加上这一行！
...
if [ "$ONLINE_ONLY" = true ]; then
    ...
    FAKE_PREP_SIZE="${FAKE_PREP_SIZE:-100}"
...
{
    echo "============================================"
    echo "CROWN Verification Summary (Naive Half-Opt)"
    echo "============================================"
