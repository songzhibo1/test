...
int main(int argc, char **argv) {
    ...
    std::string weights_file = "shark_crown_ml/crown_mpc_data/mnist_5layer_relu_20_best/weights/weights.dat";
    std::string input_file = "shark_crown_ml/crown_mpc_data/mnist_5layer_relu_20_best/images/0.bin";
    float eps = 0.01;
    int true_label = 7;
    int target_label = 2;
...
//    int target_label = 6;
    ...
    if (party != DEALER) {
        std::cout << "\n============================================" << std::endl;
        std::cout << "CROWN MPC - Fixed Version Output (Plaintext)" << std::endl;
        std::cout << "============================================" << std::endl;
...
//        std::cout << "Python: LB = -33.89, UB = 121.28 (Note: This was for eps=0.05, verify for eps=0.5)" << std::endl;
        std::cout << "============================================" << std::endl;
    }
