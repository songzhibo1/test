...
//    int num_layers = 4;
    ...
    std::string weights_file = "shark_crown_ml/crown_mpc_data/vnncomp_mnist_3layer_relu_256_best/weights/weights.dat";
    std::string input_file = "shark_crown_ml/crown_mpc_data/vnncomp_mnist_3layer_relu_256_best/images/0.bin";
    float eps = 0.01;
    int true_label = 7;
    int target_label = 3;
